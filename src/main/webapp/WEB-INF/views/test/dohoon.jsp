...
<script src="/resources/plugins/util/ajaxUtil.js"></script>
	...
	<script type="text/javascript">
		...
		// var eqSetting = {
        //     "name" : "testPump",
        // 	"electricalInterface" : "RS-232",
        // 	"synchronizationMethod" : "Start/Stop method",
        // 	"communicationSpeed" : 9600,
        // 	"dataLength" : 8,
        // 	"stopBit" : 0,
        // 	"parity" : 0,
        // 	"errorControl" : "Checksum",
        // 	"busyControl" : "none"
        // };
        // var response = ajaxEqSetting("POST", "testPump",JSON.stringify(eqSetting));
        // console.log(JSON.stringify(response));
		//
        // var ee = ajaxEqSetting("GET", "testPump", null);
        ...
        // };
		//
		// var response = ajaxComponent("DELETE", "testPump", JSON.stringify(component.name));
		// console.log(JSON.stringify(response));
		// var dd = ajaxComponent("GET", "testPump", null);
