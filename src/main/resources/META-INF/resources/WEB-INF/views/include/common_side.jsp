	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column nav-child-indent"
				...
				<li class="nav-item"><a href="/setting" class="nav-link"  id="side-eqSetting"> <i
						class="nav-icon fas fa-cog"></i>
						<p>Setting</p>
				</a></li>
				<li class="nav-item has-treeview menu-open"><a href="#"
					class="nav-link" id="side-modeling"> <i class="nav-icon fas fa-border-all"></i>
						<p>
							Modeling <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/modeling/message"
							class="nav-link" id="side-message"> <i class="far fa-circle nav-icon"></i>
								<p>Message</p>
						</a></li>
						<li class="nav-item"><a href="/modeling/scenario"
							class="nav-link" id="side-scenario"> <i class="far fa-circle nav-icon"></i>
								<p>Scenario</p>
						</a></li>
					</ul></li>
				<li class="nav-item"><a href="/execution" class="nav-link" id="side-execution"> <i
						class="nav-icon fas fa-caret-square-right"></i>
						<p>Execute</p>
				</a></li>
			</ul>
		</nav>
